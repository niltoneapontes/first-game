...
public class ObstacleGenerator : MonoBehaviour
{
    ...
    public GameObject[] obstacles; // obstaculos que podem ser gerados no game
    public List<Obstacle> obstaclesToSpawn; // lista dos obstaculos ja instanciados em cena
